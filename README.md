...
displayed answer per moment within 15 seconds; execution is automatic, routine AI play is skipped,
and the match ends with a verified result and a soccer-intelligence report (spec §15–§16 for the
soccer logic and answer catalogs). Drawing/gesture input survives only in training drills.
...
npm run pace -- 4 CM all         # real-time pace check: complete matches, 12–18 direct-involvement moments, 5–7 real minutes preferred (4–8 acceptable), per player model
